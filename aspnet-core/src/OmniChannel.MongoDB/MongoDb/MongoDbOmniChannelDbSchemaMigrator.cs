...
public class MongoDbOmniChannelDbSchemaMigrator : IOmniChannelDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbOmniChannelDbSchemaMigrator(IServiceProvider serviceProvider)
    {
